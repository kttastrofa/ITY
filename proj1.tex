% Preamble
\documentclass[10pt]{article}[25.2.2024]

% Packages
\usepackage[a4paper, top=1.8cm, inner=1.8cm, outer=1cm]{geometry}
\usepackage{multicol}
...
bude {\fontfamily{pzc}\selectfont dokument} vypadat. Čtenář tím bude {\huge \bfseries vždy nadšen!}
\end{adjustwidth}
\medskip
...
\begin{minipage}{\columnwidth}
  ...
  \footnotetext[2]{Viz \href{http://petr.olsak.net/ftp/olsak/vlna/}{\url{http://petr.olsak.net/ftp/olsak/vlna/}}}
\end{minipage}
